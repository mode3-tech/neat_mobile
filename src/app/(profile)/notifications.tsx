...
export default function NotificationsScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white px-6">
      ...
      <Text className="text-[22px] font-bold text-ink mb-6">Notification settings</Text>

      <View className="bg-surface-input rounded-2xl px-4 py-4 flex-row items-center">
        <View className="flex-1">
          <Text className="text-[15px] font-semibold text-ink">All notifications</Text>
          <Text className="text-[12px] text-ink-soft mt-0.5">Get notified on your activities</Text>
        </View>
        <Switch
