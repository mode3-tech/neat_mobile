...
import { shareReferral } from '@/utils/referral-share';
    ...
    <HeaderScreen>
      ...
      >
        ...
        <Text className="text-[13px] text-gray-500 leading-5 mb-6">
          Share your invite link with friends and earn cash rewards when they join
          NEATPay.
        </Text>
        ...
        >
          <MaterialCommunityIcons name="share-variant" size={18} color="#032252" />
        ...
        <View className="bg-[#E8EEF7] border border-[#032252]/30 rounded-2xl px-4 py-4 mt-6">
          ...
          <Text className="text-[13px] text-[#374151] leading-5">
            ...
            2. They download NEATPay and enter your code {code} when creating their
            account.{'\n'}
